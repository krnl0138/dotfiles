...
# launch cmd
COMMANDS["cmd"]="rofi -show run"
LABELS["cmd"]=""

# launch top
COMMANDS["top"]="rofi -modi top -show top"
LABELS["top"]=""

# open bookmarks
COMMANDS["bookmarks"]="sh ~/.config/rofi/rofi-bangs/rofi-surfraw-bookmarks.sh"
LABELS["bookmarks"]=""

# search local files
COMMANDS["locate"]="sh ~/.config/rofi/rofi-bangs/rofi-locate.sh"
LABELS["locate"]=""

# open custom web searches
COMMANDS["websearch"]="sh ~/.config/rofi/rofi-bangs/rofi-surfraw-websearch.sh"
LABELS["websearch"]=""
